    ...
    <div class="col-sm-12">
        ...
        <div class="row clearfix">
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <label>{{ $model->attributes()['nama_barang'] }}:</label> {{ $model->nama_barang }}
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <label>{{ $model->attributes()['deskripsi_barang'] }}:</label>  {{ $model->deskripsi_barang }}
                </div>

                <div class="form-group">
                    <label>{{ $model->attributes()['jumlah_barang'] }}:</label>  {{ $model->jumlah_barang }}
                </div> 
            </div>

            <div class="col-md-4">
                <div class="form-group">
                    <label>{{ $model->attributes()['harga_barang'] }}:  {{ $model->harga_barang }}
                </div>
            </div>
        </div>
